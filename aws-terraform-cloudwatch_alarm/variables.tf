...
variable "customer_alarms_enabled" {
  description = "Specifies whether alarms will notify customers.  Automatically enabled if provider_managed is set to false"
  type        = bool
  default     = false
}
...
variable "severity" {
  description = "The desired severity of the created provider ticket.  Supported values include: standard, urgent, emergency "
  type        = string
  default     = "standard"
}
