...
variable "support_alarms_enabled" {
  description = "Specifies whether non-emergency support alarms will create a ticket."
  type        = bool
  default     = false
}

variable "support_managed" {
  description = "Boolean parameter controlling if instance will be fully managed by support support teams, created CloudWatch alarms that generate tickets, and utilize support managed SSM documents."
  type        = bool
  default     = true
}
