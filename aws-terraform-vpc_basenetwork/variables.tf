...
variable "build_nat_instance" {
  description = "Whether or not to build a NAT instance .  if `build_nat_instance` is set to false, this value is ignored."
  type        = bool
  default     = false
}
...
variable "nat_key_pair" {
  description = "Key Pair to set of BASTION and NAT instance"
  type        = string
  default     = ""
}